...
# mariadb启动方法也是一样的
[root@localhost ~]# docker run -v /Users/wenj91/data/mysql/data:/var/lib/mysql -p 3307:3306 -e MYSQL_ROOT_PASSWORD=123456  -e MYSQL_ROOT_HOST=% --name mariadb --ulimit nofile=65536:65536 -d mariadb
